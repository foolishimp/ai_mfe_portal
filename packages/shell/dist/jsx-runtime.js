...
const moduleMap = {'react':{get:()=>()=>__federation_import(new URL('__federation_shared_react.js', import.meta.url).href),import:true,requiredVersion:'*'},'react-dom':{get:()=>()=>__federation_import(new URL('__federation_shared_react-dom.js', import.meta.url).href),import:true,requiredVersion:'*'},'@mui/material':{get:()=>()=>__federation_import(new URL('__federation_shared_@mui/material.js', import.meta.url).href),import:true,requiredVersion:'^5.0.0'},'@mui/icons-material':{get:()=>()=>__federation_import(new URL('__federation_shared_@mui/icons-material.js', import.meta.url).href),import:true,requiredVersion:'^5.0.0'},'shared':{get:()=>()=>__federation_import(new URL('__federation_shared_shared.js', import.meta.url).href),import:true}};
...
export { importShared as i, jsxRuntimeExports as j };
