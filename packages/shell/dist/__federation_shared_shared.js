...
const {Tooltip,Typography: Typography$1} = await importShared('@mui/material');
const TimeAgo = ({ timestamp, date, typography = true, variant = 'body2' }) => {
    ...
    try {
        ...
        const content = (jsxRuntimeExports.jsx(Tooltip, { title: formattedDate, children: jsxRuntimeExports.jsx("span", { children: timeAgo }) }));
        if (typography) {
            return jsxRuntimeExports.jsx(Typography$1, { variant: variant, children: content });
        }
        return content;
    }
    catch (error) {
...
const {Box,Paper,Typography} = await importShared('@mui/material');
const DiffViewer = ({ oldContent, newContent, splitView = true, title }) => {
    ...
    const formatDiff = (diff) => {
        return diff.split('\n').map((line, index) => {
            if (line.startsWith('+')) {
                return jsxRuntimeExports.jsx("div", { style: { backgroundColor: '#e6ffed' }, children: line }, index);
            }
            else if (line.startsWith('-')) {
                return jsxRuntimeExports.jsx("div", { style: { backgroundColor: '#ffdce0' }, children: line }, index);
            }
            else if (line.startsWith('@')) {
                return jsxRuntimeExports.jsx("div", { style: { backgroundColor: '#f1f8ff' }, children: line }, index);
            }
            return jsxRuntimeExports.jsx("div", { children: line }, index);
        });
    };
    if (splitView) {
        return (jsxRuntimeExports.jsxs(Box, { children: [title && jsxRuntimeExports.jsx(Typography, { variant: "h6", gutterBottom: true, children: title }), jsxRuntimeExports.jsxs(Box, { sx: { display: 'flex', height: '400px' }, children: [jsxRuntimeExports.jsxs(Box, { flex: 1, p: 2, border: "1px solid", borderColor: "divider", mr: 1, overflow: "auto", children: [jsxRuntimeExports.jsx(Typography, { variant: "subtitle2", gutterBottom: true, children: "Previous Version" }), jsxRuntimeExports.jsx("pre", { style: { margin: 0 }, children: oldContent })] }), jsxRuntimeExports.jsxs(Box, { flex: 1, p: 2, border: "1px solid", borderColor: "divider", overflow: "auto", children: [jsxRuntimeExports.jsx(Typography, { variant: "subtitle2", gutterBottom: true, children: "Current Version" }), jsxRuntimeExports.jsx("pre", { style: { margin: 0 }, children: newContent })] })] })] }));
    }
    return (jsxRuntimeExports.jsxs(Box, { children: [title && jsxRuntimeExports.jsx(Typography, { variant: "h6", gutterBottom: true, children: title }), jsxRuntimeExports.jsx(Paper, { variant: "outlined", sx: { p: 2, maxHeight: '400px', overflow: 'auto' }, children: jsxRuntimeExports.jsx("pre", { style: { fontFamily: 'monospace', whiteSpace: 'pre-wrap', margin: 0 }, children: formatDiff(diffText) }) })] }));
};

// File: packages/shared/src/components/RemoteComponent.tsx
const {useEffect,useState} = await importShared('react');

const RemoteComponent = ({ url, scope, module, fallback = jsxRuntimeExports.jsx("div", { children: "Loading remote component..." }), props = {} }) => {
    ...
    if (error) {
        ...
        return (jsxRuntimeExports.jsxs("div", { style: { padding: '16px', color: '#f44336', border: '1px solid #f44336', borderRadius: '4px', margin: '8px 0' }, children: [jsxRuntimeExports.jsx("strong", { children: "Error loading component:" }), " ", error.message] }));
    }
    return Component ? jsxRuntimeExports.jsx(Component, { ...props }) : jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, { children: fallback });
};
...
const API_BASE_URL$1 = typeof process !== "undefined" && define_process_env_default$1 && define_process_env_default$1.VITE_API_BASE_URL ? define_process_env_default$1.VITE_API_BASE_URL : "http://localhost:8000";
...
class ApiService {
  ...
  createEmptyConfig(configType, id) {
    ...
    return {
      ...
      metadata: {
        description: "",
        // Explicitly initialize description
        author: "Current User",
...
const API_BASE_URL = typeof process !== "undefined" && define_process_env_default && define_process_env_default.VITE_API_BASE_URL ? define_process_env_default.VITE_API_BASE_URL : "http://localhost:8000";
axios.create({
...
export { API_ENDPOINTS, ConfigSection, DiffViewer, EditorTab, JobStatus, ParameterType, RemoteComponent, TimeAgo, api, apiService, backwardCompatibilityAliases, configTypes, eventBus, remotes };
